...
<table  class="table "  width="100%" border="0" cellpadding="1" cellspacing="1" >           
  <tr>
    ...
    <td colspan="6">
      Total <b class="text-danger"><?=count($brands)?></b> records <!-- <a href="<?php echo base_url('customeradmin/CompanyBrand/add/'.$com_id) ?>" class="btn btn-xs btn-success" target="_blank">Add Brand </a> -->
    </td>
  </tr>
  ...
  <?php foreach ($brands as $brand) {  ?>
    <tr >
      ...
      <!-- <td align="left" valign="top" >     
        <a href="<?php echo base_url('customeradmin/CompanyBrand/delete/'.$com_id.'/'.$brand->company_brand_id ); ?>" class="btn btn-xs btn-danger" onClick="return confirm('Are you sure ? ');" target="_blank" > del</a>
