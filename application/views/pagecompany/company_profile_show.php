...
<table  class="table"  width="100%" border="0" cellpadding="1" cellspacing="1" >           
  ...
  <?php foreach ($company_profiles as $company_profile) { ?>
    <tr align="center"   >      
      ...
      <td align="left">  
        <a class="btn btn-xs btn-warning" href="<?php echo base_url('customeradmin/CompanyProfile/edit/'.$com_id.'/'.$company_profile->company_profile_id) ?>" target="_blank">edit</a>    
        <a href="<?php echo base_url('customeradmin/CompanyProfile/delete/'.$com_id.'/'.$company_profile->company_profile_id ); ?>" class="btn btn-xs btn-danger" onClick="return confirm('Are you sure ? ');" target="_blank" > del</a>
        &nbsp;
      </td>          
    </tr>      
  <? } ?>
