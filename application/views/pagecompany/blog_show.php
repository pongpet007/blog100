...
<table  class="table"  width="100%" border="0" cellpadding="1" cellspacing="1" >           
  <tr>
    <td colspan="5">
      Total <b class="text-danger"><?=count($blogs)?></b> records <a href="<?php echo base_url('customeradmin/CompanyBlog/add/'.$com_id) ?>" class="btn btn-xs btn-success" target="_blank"> Add Blog </a>
    </td>
  </tr>
  ...
  <?php foreach ($blogs as $blog) { ?>
    <tr align="left"   >
      ...
      <td align="left">  
        <a class="btn btn-xs btn-warning" href="<?php echo base_url("customeradmin/CompanyBlog/edit/$com_id/".$blog->blog_id) ?>" target="_blank">edit</a>    
        <a href="<?php echo base_url("customeradmin/CompanyBlog/delete/$com_id/".$blog->blog_id ); ?>" class="btn btn-xs btn-danger" onClick="return confirm('Are you sure ? ');" target="_blank" > del</a>
        &nbsp;
      </td>          
    </tr>      
  <? } ?>
