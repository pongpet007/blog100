...
<table  class="table"  width="100%" border="0" cellpadding="1" cellspacing="1" >           
  ...
  <tr align="center" class="bg-info" >
      <th height="25" >
      <span class="">Ads </span> 
      <!-- <a href="<?php echo base_url('CompanyAds/add/'.$com_id) ?>" class="btn btn-xs btn-success" target="_blank"> Add Ads </a> --></th>   
      <th>Active</th>      
  ...
  <?php foreach ($adss as $ads) { ?>
    <tr align="center"   >
      <td align="left">
          <?php 
           $filepath = "assets/images/ads/{$ads->company_ads_id}.jpg";
            if(is_file($filepath)){
