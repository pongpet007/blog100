            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-12" style="text-align: center;">
                    <div class="header-top-right pr-30">
                        <ul>
                            <li>
                                <a href="http://line.me/ti/p/~<?=$companyData->line_id?>"><img src="<?php echo base_url() ?>images/icon-line.jpg" style="padding-right: 5px; max-width: 29px;"><?=$companyData->line_id?></a>
                            </li>
                            <li>
                                <a href="<?=$companyData->facebook?>"><img src="<?php echo base_url() ?>images/icon-face.jpg"style="padding-right: 5px; max-width: 29px;">Facebook</a>
                            </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-1" style="text-align: center;">
                        <div class="logo logo-mrg">
                            <a href="index.html">
                            <img src="<?php echo base_url() ?>images/logo/logo.png" style="max-width: 300px;" alt="">
                            </a>
                        </div>
                    </div>
