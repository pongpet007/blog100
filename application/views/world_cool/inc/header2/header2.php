<header class="header-area header-position" style="position: unset; background-image: url(<? echo base_url() ?>assets_theme_2020_v1/dunlop/bg.jpg); background-size: 100%; background-repeat: no-repeat;">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-12">
                    <div class="header-top-left pl-30">
                        <div class="language-currency">
                            <span><?=$lang=='EN'?'Change language':'เปลี่ยนภาษา'?>:</span>
                ...
                <div class="col-lg-8 col-md-7 col-12" style="text-align: center;">
                    <div class="header-top-right pr-30">
                        <ul>
                            <li>
                                <a href="http://line.me/ti/p/~<?=$companyData->line_id?>"><img src="<?php echo base_url() ?>assets_theme_2020_v1/img/intiporn/line.png" style="padding-right: 5px;"><?=$companyData->line_id?></a>
                            </li>
                            <li>
                                <a href="<?=$companyData->facebook?>"><img src="<?php echo base_url() ?>assets_theme_2020_v1/img/intiporn/facebook.png"style="padding-right: 5px;">Facebook</a>
                            </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-1" style="text-align: center;">
                        <div class="logo logo-mrg">
                            <a href="index.html">
                            <img src="<?php echo base_url() ?>images/logo.png" style="max-width: 300px;" alt="">
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="mobile-menu">
                                <nav id="mobile-menu-active">
                                    <ul class="menu-overflow">                                       
                                        ...
                                        <li>
                                            <a href="<?=$url ?> ">
                                                <?=$lang=='EN'?$menu->menu_en:$menu->menu_th?>
                                            </a>
                                            ...
                                            <ul class="">
                                                ...
                                                ?>
                                                <li>
                                                    <a href="<?=$url ?>"><?=$lang=='EN'?$menu2->menu_en:$menu2->menu_th?> </a>
                                                </li>
                                                <?php } ?>
                                            </ul>
                                            <?php } ?>
