<style type="text/css">
	...
	****************************/
	...
	.section-border h4:hover{
		color: #3083d0;
	}
	.blog-content a{
		color: #000;
	}
	.blog-content > h4 a:hover, .blog-wrapper-2 .blog-meta ul li a:hover {
	    color: #3083d0;
	}
	...
	.devita-product-2:hover .list-col .gridview2 {
	    margin-bottom: -166px;
	}
	.devita-product-2 .list-col .gridview2 {
	...
	.devita-product-2 .list-col .gridviewnew {
	    padding: 0px 5px 30px 0px;
	}

	.mrg-inherit .product-contentnew {
	    padding: 15px 10px 0;
	}

	.product-contentnew > h4{
		font-size: 16px;
	}
	.btn-success {
	    color: #fff;
	...
	.blog-wrapper-2-news h4{
		min-height: 48px;
		max-height: 48px;
	}

	.blog-wrapper-2-news p{
		overflow: hidden;
	    text-overflow: ellipsis;
	    display: -webkit-box;
	    -webkit-line-clamp: 2;
