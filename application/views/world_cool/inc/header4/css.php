...
.product-img-slider .cr-navigation:hover {
    color: #fff;
    background: rgba(74, 165, 59, 0.8) none repeat scroll 0 0;
}
/* banner area */
.connect-content > h2 {
    font-size: 48px;
...
.owl-dot-style-2 .owl-dot.active {
    background: #f2d201 none repeat scroll 0 0;
    height: 13px;
    position: relative;
    top: 2px;
    width: 13px;
...
.product-tab-list > a h4:hover {
	...
	<? } ?>
	.header-search.header-search-coffee:hover form input{
		border: 2px solid #f2d201;
	}
    ...
    .color-language-hd1 a {
    	color: #fff;
    }
    .color-language-hd1 a:hover {
    	color: #f2d201;
    }

    @media (max-width: 991px) and (min-width: 300px){
	    .bg-headers {
	    	background-image: url(<? echo base_url() ?>images/bg/1.jpg); 
	    	background-size: cover;  
	    	background-repeat: no-repeat;
	    }
    }
    ...
    @media (min-width: 1600px){
	    ...
	    .header-contact-search-wrapper, .header-contact {
		    margin-top: 31px;
		}
    }
    ...
    .header-search.header-search-coffee:hover form button{
        background-color: #f2d201;
    }
    .header-cart:hover .icon-cart{
        border: 2px solid #f2d201;
    }
    .header-cart:hover button.icon-cart span.count-style{
        background-color: #f2d201;
    }
    .blog-content h4 {
        max-height: 48px;
    ...
    .header-top-color-2 .lang-curr-dropdown ul li a:hover ,.header-top-color-2 .language-currency span:hover{
        color: #f2d201;
    }
    .header-top-color-2 .language-currency span{
        color: #fff;
    ...
    .header-top-color-2 .header-color-font span, .header-color-font-main a, .header-top-color-2 .header-color-font span:hover,  .header-top-color-2 .header-top-right-color ul li a{
        color: #fff;
    }
    .header-top-color-2 .header-color-font .lang-curr-dropdown ul li a{
    	color: #000;
    }
    .header-top-color-2 .header-color-font .lang-curr-dropdown ul li .language-click{
    	color: #fff;
    }
    .header-top-color-2 .header-color-font .lang-curr-dropdown ul li a:hover, .header-color-font-main a:hover, 
    .header-top-color-2 .header-top-right-color ul li a:hover,.favorite-color .icon-cart .cart-bag:hover{
        color: #f2d201;
    }
    .header-contact-content-color a:hover{
    	color: #2aa53b;
    }
    .header-color-font .lang-curr-dropdown ul li ul{
       background: #fff none repeat scroll 0 0;
    }
    .header-top-color-2 .header-color-font::before {
        background-color: #fff;
    }
    a:not([href]):not([tabindex]), .header-contact-content-color a {
        color: #000;
        text-decoration: none;
    }
    .favorite-color .icon-cart .cart-bag{
        color: #2aa53b;
    }
    .blog-meta-bundle .blog-meta a {
        color: #000;
    }
    .blog-meta-bundle .blog-meta a:hover {
        color: #2aa53b;
    }
