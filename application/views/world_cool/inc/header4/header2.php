<header class="header-area">
    <div class="header-top header-top-color-2 header-top-coffee pt-10 pb-13 white-bg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="header-top-left header-color-font-main pl-30">
                        <div class="language-currency header-color-font">
                        ...
                        <a href="<?php echo base_url("Home/stat") ?>" style="font-size: 12px;">
                ...
                <div class="col-lg-6 col-md-12 col-12" style="text-align: center;">
                    <div class="header-top-right header-top-right-color pr-30">
                        <ul>
    ...
    <div class="header-middle">
        <div class="container">
            <div class="header-middle-bg-img">
                <div class="row">
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-3  qrcode">
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 col-sm-6  ">
                        <div class="header-contact middle-same" style="    padding-left: 19px;">
                            ...
                            <div class="header-contact-content header-contact-content-color">

                                <p><span style="color: #000;"><?=$lang=='EN'?'Call us:':'ติดต่อเรา:' ?></span><br><span style="color: #2aa53b; font-weight: bold;"><?=$lang=='EN'?'Free Support':'
                                    สายด่วนได้ที่' ?>: <?
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-6">
                        ...
                        <div class="header-contact-search-wrapper f-right">
                            ...
                            <div class="header-cart middle-same favorite favorite-color">
                                        ...
                                        <?php foreach ($this->cart->contents() as $product) { ?>
                                            <li class="single-shopping-cart">
                                                <div class="shopping-cart-img">
                                                    <a target="_blank" href="<?=base_url("products/detail/{$product['id']}")?>"><img style="max-width: 82px;" alt="" src="<?php echo base_url(); ?>/images/product_new/pro_<?php echo $product['id']; ?>01small.jpg"></a>
                                                </div>
    ...
    <div class="header-bottom header-btm-coffee-res">
        <div class="container-fluid white-bg" style="">
            <div class="row">
                <div class="container">
                    ...
                    <div class="white-bg menu-coffee-color">
                        <div class="row">
                            <div class="col-lg-12">
