<style type="text/css">
	...
	****************************/
	...
	<?/* START blog theme SBL ENTERPRISE */?>
		.news_home .new_h4 {
			font-size: 30px;
			margin-bottom: 15px;
		}
		.news_home .new_company {
			font-size: 20px;
			margin-bottom: 15px;
			color: #E75A24;
		}
		.news_home .new_detail {
			font-size: 16px;
			margin-bottom: 15px;
		}
		.box-bor-shadow {
		    box-shadow: 5px 5px 5px 5px rgba(165, 165, 165, 0.5);
		    background: #fff;
		}
	...
	<?/* END blog theme SBL ENTERPRISE */?>

	<?/* START PRODUCT theme SBL ENTERPRISE */?>
	.news_home > h2::before {
    ...
    <?/* END PRODUCT theme SBL ENTERPRISE */?>
