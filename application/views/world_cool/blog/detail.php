    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li ><a href="<?php echo base_url() ?><?=$this->session->userdata('site_lang_name')?>/article"><?=lang('Blog') ?></a></li>               
...
<div class="blog-area ">
    <div class="container">
            ...
            <div class="col-lg-12">
                <div class="blog_dec_tags">
                    <ul>
                        ...
                        if(strstr($blog->blog_tags, ',')){
                            $keywords = explode(',', $blog->blog_tags);

                            $keywords2 = explode(',', $blog->blog_tags_url);
                                            // print_r($keywords);
                            ...
                            $arr[$row][0] = $blog->blog_tags;
                            $arr[$row][1] = $blog->blog_tags_url;
                            $row++;
                        }           
                        $newarr = array();
                        ...
                        foreach ($newarr as $key => $newnewarr) {
                            $arr[] ='<li><a href="'. base_url($this->session->userdata('site_lang_name')."/article-tags/$key").'">'.$newnewarr .'</a></li>';
                        }
        ...
        <div class="row" style="margin-bottom: 30px;">
            <div class="col-lg-12">
                <div class="share">
                    <? $urlshare = base_url()."".$this->session->userdata('site_lang_name')."/article-detail/".$blog->blog_url ?>
