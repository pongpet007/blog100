...
<div class="blog-area pt-30 pb-30">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                <h3 style="margin-bottom: 2.0rem;"><?=$lang=='EN'?'Portforio':'ผลงานของเรา' ?></h3>
            </div>
            <?php foreach ($gallery as $key => $allgallery) { ?>
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="blog-wrapper mb-30 main-blog">
                        ...
                        <h3><a href="<? echo base_url() ?>Gallery/detail/<? echo $allgallery->gallery_id ?>"><?=$lang=='EN'?$allgallery->gallery_name:$allgallery->gallery_name_th ?></a></h3>
