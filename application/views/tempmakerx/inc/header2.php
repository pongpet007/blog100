                        ...
                        <div class="container">
                            <ul class="list-unstyled list-inline ct-topbar__list">
                                <li class="ct-language">
                                        <?=$lang=='EN'?'Change language':'เปลี่ยนภาษา'?> <i class="fa fa-google" aria-hidden="true"></i> : <i class="fa fa-arrow-down"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-xs-8">
                        <div class="col-sm-4 col-xs-4" style="padding-right: 10px;padding-left: 10px;">
                            <a target="_blank" href="<?= $companyData->facebook ?>" class="pull-right"><img class="img-responsive" src="<?= base_url() ?>assets_theme_2020_v2/img/home/2.png"></a>
                        </div>
                        <div class="col-sm-4 col-xs-4" style="padding-right: 10px;padding-left: 10px;">
                            <a target="_blank" href="<?= $companyData->line_id ?>" class="pull-right"><img class="img-responsive" src="<?= base_url() ?>assets_theme_2020_v2/img/home/3.png"></a>
                        </div>
                        <div class="col-sm-4 col-xs-4" style="padding-right: 10px;padding-left: 10px;">
                            <a target="_blank" href="<?= $companyData->youtube ?>" class="pull-right"><img class="img-responsive" src="<?= base_url() ?>assets_theme_2020_v2/img/home/4.png"></a>
                        </div>
                    </div>
                </div>
            </div>
