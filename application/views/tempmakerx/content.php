            ...
            <div class="container">
                <div class="breadcrumb-content">
                    <ol class="breadcrumb">
                      ...
                      <li><?=$lang=='EN'?$breadcrumb_en:$breadcrumb_th?></li>
                    </ol>                    
                </div>
            </div>
        </div>
     	...
     	<div class="<?=$row->is_fullwidth==1?'container-fluid':'container'?> " >
            <div class="rowwrap<?=$row->row_id ?>">                
                    ...
                    foreach ($row->items as $item) {
                        ...
                        elseif($item->template_id==9){ // Contactus information
                        ...
                        elseif($item->template_id==14){ // Gallery
                            $this->load->view($theme_path."/template_display/item_gallery",array('item_id'=>$item->item_id,'jsondata'=>$item->jsondata));
                        }
