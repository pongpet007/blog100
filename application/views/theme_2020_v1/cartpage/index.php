                            ...
                            <div class="cart-tax">
                                ...
                                <div class="tax-wrapper">
                                    <div class="tax-select-wrapper">
                                        ...
                                        <div class="tax-select">
                                            <input type="email" name="email"  placeholder="<?=$lang=='EN'?'E-mail':'อีเมล์'?>"  value="<?=set_value('email')?set_value('email'):'' ?>"   required>
                                        </div>
                                        <div class="tax-select">
                                        ...
                                        <?php echo $script;?>
                                        <br>
                                        <button class="cart-btn-2" type="submit" style="width: 100%;background-color: #58be09;color: #fff;" >ส่งขอใบเสนอราคา</button>
                                    </div>
                                </div>
                            </div>
                        </div>
