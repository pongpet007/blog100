<?php $this->load->view('theme_2020_v1/product/nevbar') ?>
<div class="shop-page-area pt-30 pb-65">
    <div class="container-fluid">
        <div class="row flex-row-reverse">
            <div class="col-lg-9">
                <div class="banner-area pb-30">
                    <a href="#"><img alt="" src="<?php echo base_url() ?>assets_theme_2020_v1/image/slider/02.png"></a>
                </div>
                <div class="shop-topbar-wrapper">
                    <div class="shop-topbar-left">
                        ...
                        <?php /* ?>
                        <!-- <p>Showing <? echo $starts ?> - <? echo $ends ?> of <? echo $total_rows ?> results  </p> -->
                        <?php */ ?>
                    </div>
                    <?php /* ?>
                    <!-- <div class="product-sorting-wrapper">
                        <div class="product-shorting shorting-style">
                            <label style="display: inline;">View:</label>
                            <div style="display: inherit;" class="dropdown">
                                ...
                                <ul class="dropdown-menu nav-menu1">
                                    <li style="padding-left: 10px;"><a href="<?php echo base_url("Products") ?>/showtag/<?php echo $tag ?>?cat_id=<?php echo $cat_id?>">12</a></li>
                                    <li style="padding-left: 10px;"><a href="<?php echo base_url("Products") ?>/showtag/<?php echo $tag ?>?cat_id=<?php echo $cat_id?>&view=2&order=<? echo $orderby; ?>">24</a></li>
                                    <li style="padding-left: 10px;"><a href="<?php echo base_url("Products") ?>/showtag/<?php echo $tag ?>?cat_id=<?php echo $cat_id?>&view=3&order=<? echo $orderby; ?>">60</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="product-show shorting-style">
                            ...
                            <div style="display: inherit;" class="dropdown">
                                ...
                                <ul class="dropdown-menu nav-menu1">
                                    <li style="padding-left: 10px;"><a href="<?php echo base_url("Products") ?>/showtag/<?php echo $tag ?>?cat_id=<?php echo $cat_id?>">Default</a></li>
                                    <li style="padding-left: 10px;"><a href="<?php echo base_url("Products") ?>/showtag/<?php echo $tag ?>?cat_id=<?php echo $cat_id?>&view=<? echo $views ?>&order=2">Name</a></li>
                                </ul>
                            </div>
                        </div>
                    </div> -->
                ...
                <div class="tab-content jump">
                    <div class="tab-pane active pb-20" id="product-grid">
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 mb-30" style="margin-bottom: 75px;">
                                <div class="devita-product-2 mrg-inherit">
                                    ...
                                    <div class="list-col">
                                        <div class="gridview">
                                            <div class="product-content text-center" style="padding-top: 11px;">
                                            ...
                                            <div class="product-action-wrapper-2 text-center">
                                                <p><?=$lang=='EN'?$productall->pro_shot_detail_en:$productall->pro_shot_detail_th ?></p>
                                                <div class="product-action">
                                                    <a class="action-cart" title="ขอใบเสนอราคา" href="<? echo base_url(); ?>Products/quotation/<? echo $productall->pro_id ?>?qtybutton=01">
                                                    ขอใบเสนอราคา
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="product-list-wrapper shop-border mb-40 pb-40">
                                    ...
                                    <div class="product-list-content" style="min-height: 240px;">
                                        ...
                                        <div class="product-action">
                                            <a class="action-cart" href="<? echo base_url(); ?>Products/quotation/<? echo $productall->pro_id ?>?qtybutton=01" title="Add To Cart"> Add to Cart </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <?php $this->load->view('theme_2020_v1/product/menu-left') ?>
        </div>
    </div>
</div>