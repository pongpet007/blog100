        ...
        <div class="row flex-row-reverse">
            <div class="col-lg-9">
                <div class="banner-area pb-30">
                    <a href="#"><img alt="" src="<? echo base_url();?>assets_theme_2020_v1/img/intiporn/bp.jpg"></a>
                </div>
                        ...
                        <div class="product-shorting shorting-style">
                            ...
                            <div style="display: inherit;" class="dropdown">
                                ...
                                <ul class="dropdown-menu nav-menu1">
                                    <li style="padding-left: 10px;"><a href="<?php echo base_url("Products") ?>?cat_id=<?php echo $cat_id?>">12</a></li>
                                    <li style="padding-left: 10px;"><a href="<?php echo base_url("Products") ?>?cat_id=<?php echo $cat_id?>&view=2&order=<? echo $orderby; ?>">24</a></li>
                ...
                <div class="tab-content jump">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-xs-6 mb-30" style="margin-bottom: 75px;">
