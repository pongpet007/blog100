<section id="page-banner" class="page-banner-main-block" style="background-image: url('<?php echo base_url() ?>assets_theme_2020_v2/img/about/1.png')">
  <h1 class="page-banner-heading text-center">เกี่ยวกับเรา</h1>
</section>
<!--  end page banner  -->
<!--  breadcrumb -->
...
<?PHP if ($companyData->about_active == 1) { ?>
  <?php echo $companyData->about_content_th ?>
<? } ?>

<?PHP if ($companyData->about_active == 2) { ?>
