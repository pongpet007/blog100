<footer class="footer-area" style="padding: 45px 0 ; <?=$companyData->packageBG?'background-color: '.$companyData->packageBG.';':''?> background-size: 100% 100%; background-repeat: no-repeat;border-top: 0px solid #ffdd00;">
    <div class="container">
        <div class="row">
