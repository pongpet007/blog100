        ...
        <div id="item<?=$item_id?>" class="picture">
              ...
              if(isset($i->picture)){
                  ...
                  if(is_file($filepath)){
                    ...
                    echo '<img style="width:100%;" class="d-none d-xl-block d-lg-block img-fluid" src="'. base_url($filepath) .'" />';
              ...
              if(isset($i->picture2)){
                  ...
                  if(is_file($filepath2)){
                    ...
                    echo '<img style="width:100%;" class="d-block d-sm-block d-md-block d-lg-none d-xl-none img-fluid" src="'. base_url($filepath2) .'" />';
