...
.description-review-topbar a.active {
    border-bottom: 2px solid #174ea9;
    color: #000;
}
...
.pro_type2 .product-content > h4 a {
    color: #000;
}
.pro_type2 .product-action-wrapper-2 > p {
    color: #000;
}
.pro_type3 h2{
    color: #fff;
}
.pro_type3 .product-content > h4 a {
    color: #000;
}
.pro_type3 .product-action-wrapper-2 > p {
    color: #000;
}
.highlight{
    height: 120px;
...
.header-top-color-2 .lang-curr-dropdown ul li a, .header-top-color-2 .language-currency span, .header-top-color-2 .header-top-right ul li a, .header-middle-color-2 .header-contact-content > p, .header-middle-color-2 .header-contact-icon i, .header-middle-color-2 button.icon-cart span.count-amount{
	color: black;
}
...
.item16 .text-desc , .item17 .text-desc , .item18 .text-desc {				
	text-align: justify;
}
.header-middle-bg-img{
	padding: 0 25px;
