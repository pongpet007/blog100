                        ...
                        <div class="ct-topbar language-currency">
                            <ul class="list-unstyled list-inline ct-topbar__list">
                                <li class="ct-language">
                                    Language <i class="fa fa-google" aria-hidden="true"></i> <i class="ion-chevron-down"></i> 
                                    <ul class="list-unstyled ct-language__dropdown">
                                        <li><a href="#googtrans(en|th)" class="lang-en lang-select" data-lang="th"><img src="<?php echo base_url() ?>/images/lang/flag-th.png" alt="Thai"></a><span> TH</span></li>
                                            <li><a href="#googtrans(th|en)" class="lang-en lang-select" data-lang="en"><img src="<?php echo base_url() ?>/images/lang/flag-usa.png" alt="USA"></a><span> EN</span></li>
                                            <li><a href="#googtrans(en|km)" class="lang-en lang-select" data-lang="km"><img src="<?php echo base_url() ?>/images/lang/KH.png" alt="USA"></a><span> KH</span></li>
                                            <li><a href="#googtrans(en|lo)" class="lang-en lang-select" data-lang="lo"><img src="<?php echo base_url() ?>/images/lang/LA.png" alt="USA"></a><span> LA</span></li>
                                            <li><a href="#googtrans(en|my)" class="lang-en lang-select" data-lang="my"><img src="<?php echo base_url() ?>/images/lang/MM.png" alt="USA"></a><span> MM</span></li>
                                            <li><a href="#googtrans(en|vi)" class="lang-en lang-select" data-lang="vi"><img src="<?php echo base_url() ?>/images/lang/VN.png" alt="USA"></a><span> VN</span></li>
                                            <li><a href="#googtrans(en|ja)" class="lang-en lang-select" data-lang="ja"><img src="<?php echo base_url() ?>/images/lang/JP.png" alt="USA"></a><span> JP</span></li>
                                            <li><a href="#googtrans(en|zh-CN)" class="lang-en lang-select" data-lang="zh-CN"><img src="<?php echo base_url() ?>/images/lang/CN.png" alt="USA"></a><span> CN</span></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="container">
            <div class="header-middle-bg-img">
                <div class="row">   
                    ...
                    <div class="col-xl-4 d-lg-none d-md-none d-none d-xl-block col-md-12">
                        <div class="header-contact-search-wrapper f-left">
                            <div class="header-contact middle-same" >
                                <div>
                                    <?=$companyData->com_name_th ?><br>
                                    <?=$companyData->com_name_en ?><br>
                                </div>
                            </div>
                        </div>
                    </div>               
