<header class="header-area" style="position: unset; background-image: url(<? echo base_url() ?>assets_theme_2020_v1/dunlop/bg.jpg); background-size: 100%; background-repeat: no-repeat;">
