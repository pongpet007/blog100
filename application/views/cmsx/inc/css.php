...
.description-review-topbar a.active {
    border-bottom: 2px solid #f2d201;
    color: #FFFFFF;
}
...
.bluetags:hover{
	...
	.item14 .wrap ,.item24 .wrap{
		background-color: white;
		border-radius: 30px;
	}

	.item14 .wrap h2,.item24 .wrap h2{
		color: black;
	}
    .contact-information h4 , .contact-information p{
        color: black;
    }
    .contact-information > p a:hover{
        color: #000;
    ...
    h3.page-title,h4.cart-bottom-title{
        color:black;
