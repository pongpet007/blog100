<footer class="footer-area pt-65" style=";padding-top: 47px; background-image: url(<?=base_url("assets_theme_2020_v1/dunlop/bgfooter.png")?>); background-size: 100%; background-repeat: no-repeat; ">
    <div class="container">
        <div class="row">
    ...
    <div class="footer-bottom black-bg-2 pb-25 pt-25" style="border-top: solid 1px #ffffff14;background-color: #000; ">
        <div class="container">
            <div class="row">
                <div class="col-12">
