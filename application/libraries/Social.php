...
class Social {
	...
	public function facebook_connect($redirectUrl=null,$sessionHandler,$site_url,$fb_App_id,$fb_secret,$fb_scope,$error_description = 'error description') {
		...
		require_once(APPPATH.'third_party/loginSocial/facebook/autoload.php');
		require_once(APPPATH.'third_party/loginSocial/facebook/FbRedirectLoginHelper.php');
	...
	public function twitter_connect($twt_app_id,$twt_secret,$site_url) {
		...
		require_once(APPPATH.'third_party/loginSocial/twitter/autoload.php');
	...
	public function linkedin_connect($redirectUrl=null,$site_url,$ldn_api_key,$ldn_secret_key) {
		require_once(APPPATH.'third_party/loginSocial/linkedin/src/LinkedIn/Client.php');
		if(empty($redirectUrl)) {
	...
	public function foursquare_connect($fs_client_id,$fs_client_secret,$site_url) {
		require_once(APPPATH.'third_party/loginSocial/foursquare/src/FoursquareAPI.class.php');
	...
	public function gmail_connect($redirectUrl=null,$site_url,$gmail_client_id,$gmail_client_secret,$gmail_api_key) {
		require_once(APPPATH.'third_party/loginSocial/google/src/Google/autoload.php');
		if(empty($redirectUrl)) {
	...
	public function yahoo_connect($site_url) {
		require_once(APPPATH.'third_party/loginSocial/openid/Lightopenid.php');
