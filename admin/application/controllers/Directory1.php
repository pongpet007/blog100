...
class Directory1 extends CI_Controller {
	...
	public function loadSub($dir_id){
		...
		echo '<tr align="center" >
			  ...
			  <th height="25"><span class="">subdomain</span></th>
	...
	public function add(){
			...
			if($this->form_validation->run()==FALSE){
				...
				if(isset($_FILES['picture2'])&&$_FILES['picture2']['size']>0){
					 $filepath = "../images/directory/". $dir_id .'ads2.jpg';
	...
	public function delete($id){
		...
		$filepath = "../images/directory/". $id .'.jpg';
		if(is_file($filepath))
			unlink($filepath);
		
		$filepath = "../images/directory/". $id .'ads1.jpg';
		if(is_file($filepath))
			unlink($filepath);

		$filepath = "../images/directory/". $id .'ads2.jpg';
		if(is_file($filepath))
			unlink($filepath);
