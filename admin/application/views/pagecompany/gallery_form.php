  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Gallery <?=$method?></a>
      </h4>
    </div>
    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
      ...
      <?php 
        ...
        echo form_open_multipart("CompanyGallery/$method/$com_id/$gallery_id",$attributes); ?>
      <div class="form-group">
        <label class="col-md-2 control-label" for="">Picture</label>
        <div class="col-md-10 ">
          <?php 
            $gallery_id = is_object($gallery)?$gallery->gallery_id:'';
      ...
      <div class="form-group ">
            <label class="col-md-2 control-label" for="">Gallery Url</label>
              <div class="col-md-10">
              <?php 
              $gallery_url = is_object($gallery)?$gallery->gallery_url:'';
              $data = array(
                  'class' =>'form-control' ,
                  'name' =>'gallery_url',
                  'id'=>'gallery_url',
                  'placeholder' => 'gallery_url' ,
                  'value' => set_value('gallery_url')?set_value('gallery_url'):$gallery_url,
              );
      ...
      <div class="form-group">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <?php 
            $is_active = is_object($gallery)?$gallery->is_active:set_value('is_active');  
            $data = array(
              'class' =>'form-control' ,                 
              'id'=>'is_active',
            );
      ...
      <div class="form-group">
              ...
              <div class="col-md-6">
                <?php 
                  $cat_id = is_object($gallery)?$gallery->cat_id:set_value('cat_id');
                  $data = array(
                      'class' =>'form-control' ,                  
                      'id'=>'cat_id',                                 
                  );
...
echo form_open_multipart("#",$attributes); ?>
      ...
      <div id="language" style="display: none;">
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label" for="">gallery_name</label>
                  <div class="col-md-10 ">
                    <?php 
                      ...
                      $data = array(
                          ...
                          'value' => set_value('gallery_name')?set_value('gallery_name'):'',
                      );
                      echo form_input($data); ?>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label" for="">gallery detail short</label>
                  <div class="col-md-10 ">
                    <?php 
                      ...
                      $data = array(
                          'class' =>'form-control ' ,
                          'rows'=>2,
                          'name' =>'gallery_desc_short',
                          'id'=>'gallery_desc_short',
                          'placeholder' => 'gallery_desc_short' ,
                          'value' => set_value('gallery_desc_short')?set_value('gallery_desc_short'):'',
                      );
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label" for="">gallery detail</label>
                  <div class="col-md-10 ">
                    <?php 
                      ...
                      $data = array(
                          ...
                          'name' =>'gallery_desc',
                          'id'=>'gallery_desc',
                          'placeholder' => 'gallery_desc' ,
                          'value' => set_value('gallery_desc')?set_value('gallery_desc'):'',
                      );
                      echo form_textarea($data); ?>
                  </div>
                </div>      
        ...
        <?php foreach ($languages as $language) { 
           ...
           <div class="table-responsive countryall country<?=$language->country_id ?>">
                  <table class="table table-striped">
                    ...
                    <tr>
                      <td>gallery name</td>
                      <td><?=$cl->gallery_name ?></td>
                    </tr> 
                     <tr>
                      <td>gallery detail short</td>
                      <td><?=$cl->gallery_desc_short ?></td>
                    </tr>  
                    <tr>
                      <td>gallery detail</td>
                      <td><?=$cl->gallery_desc ?></td>
                    </tr>                     
                    <tr>
                      <td>cby / cdate</td>
...
<script type="text/javascript">
  ...
  function editlanguage(id) {
      ...
      $.getJSON( "<?=base_url("CompanyGallery/getLanguageJson/")?>"+id, function( data ) {       
        $('#country_id').val(data.country_id);
        $('#meta_title').val(data.meta_title);
        $('#meta_keyword').val(data.meta_keyword);
        $('#meta_description').val(data.meta_description);
        $('#gallery_name').val(data.gallery_name);                 
        $('#gallery_desc_short').val(data.gallery_desc_short);                 
        CKEDITOR.instances.gallery_desc.setData(data.gallery_desc);
        $('#language_id').val(id);
        $('#language').show();
        $('#country_id').focus();
      });
  ...
  function deletelanguage(id) {
    if(confirm('Delete this language?')){
      $.get('<?=base_url("CompanyGallery/deletelanguage/")?>' + id,function (data) {        
  ...
  function savelanguage() {
    ...
    var gallery_desc = CKEDITOR.instances.gallery_desc.getData();    
    frm = frm +'&gallery_desc='+gallery_desc;
    

    $.post('<?=base_url("CompanyGallery/savelanguage")?>',frm,function(data) {
