  ...
  <div class="panel panel-default">
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Youtube <?=$method?></a>
      </h4>
    </div>
    ...
    <?php 
      ...
      echo form_open_multipart("CompanyYoutube/$method/$com_id/$youtube_id",$attributes); ?>
          ...
          <div class="form-group">
            <label class="col-md-2 control-label" for="">Media Type</label>
              <div class="col-md-3 col-sm-6 col-xs-12">
              <?php 
                $media_type = is_object($youtube)?$youtube->media_type:set_value('media_type');  
                $data = array(
                  'class' =>'form-control' ,                 
                  'id'=>'media_type',
                );

                $options = array(1=>'Youtube',2=> 'Facebook');
                echo form_dropdown('media_type', $options , $media_type ,$data);
                ?>
              </div>
          </div>
...
echo form_open_multipart("#",$attributes); ?>
      ...
      <div id="language" style="display: none;">
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label" for="">youtube_name</label>
                  <div class="col-md-10 ">
                    <?php 
                      ...
                      $data = array(
                          ...
                          'name' =>'youtube_name',
                          'id'=>'youtube_name',
                          'placeholder' => 'youtube_name' ,
                          'value' => set_value('youtube_name')?set_value('youtube_name'):'',
                      );
                      echo form_input($data); ?>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label" for="">youtube detail short</label>
                  <div class="col-md-10 ">
                    <?php 
                      ...
                      $data = array(
                          'class' =>'form-control' ,
                          'rows'=>2,
                          'name' =>'youtube_desc_short',
                          'id'=>'youtube_desc_short',
                          'placeholder' => 'youtube_desc_short' ,
                          'value' => set_value('youtube_desc_short')?set_value('youtube_desc_short'):'',
                      );
                ...
                <div class="form-group">
                  <label class="col-md-2 control-label" for="">youtube detail</label>
                  <div class="col-md-10 ">
                    <?php 
                      ...
                      $data = array(
                          ...
                          'name' =>'youtube_desc',
                          'id'=>'youtube_desc',
                          'placeholder' => 'youtube_desc' ,
                          'value' => set_value('youtube_desc')?set_value('youtube_desc'):'',
                      );
                      echo form_textarea($data); ?>
                  </div>
                </div>          
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-10 ">
                    <input type="hidden" id="youtube_id" name="youtube_id" value="<?=$youtube_id ?>">
          ...
          <?php foreach ($languages as $language) { 
           ...
           <div class="table-responsive countryall country<?=$language->country_id ?>">
                  <table class="table table-striped">
                    ...
                    <tr>
                      <td>youtube name</td>
                      <td><?=$cl->youtube_name ?></td>
                    </tr> 
                    <tr>
                      <td>youtube detail short</td>
                      <td><?=$cl->youtube_desc_short ?></td>
                    </tr>  
                    <tr>
                      <td>youtube detail</td>
                      <td><?=$cl->youtube_desc ?></td>
                    </tr>                     
                    <tr>
                      <td>cby / cdate</td>
...
<script type="text/javascript">
  ...
  function editlanguage(id) {
      ...
      $.getJSON( "<?=base_url("CompanyYoutube/getLanguageJson/")?>"+id, function( data ) {       
        $('#country_id').val(data.country_id);
        $('#meta_title').val(data.meta_title);
        $('#meta_keyword').val(data.meta_keyword);
        $('#meta_description').val(data.meta_description);
        $('#youtube_name').val(data.youtube_name);                 
        $('#youtube_desc_short').val(data.youtube_desc_short);                 
        CKEDITOR.instances.youtube_desc.setData(data.youtube_desc);
        $('#language_id').val(id);
       $('#language').show();
        $('#country_id').focus();
      });
  ...
  function deletelanguage(id) {
    if(confirm('Delete this language?')){
      $.get('<?=base_url("CompanyYoutube/deletelanguage/")?>' + id,function (data) {        
  ...
  function savelanguage() {
    ...
    var youtube_desc = CKEDITOR.instances.youtube_desc.getData();    
    frm = frm +'&youtube_desc='+youtube_desc;
    

    $.post('<?=base_url("CompanyYoutube/savelanguage")?>',frm,function(data) {
