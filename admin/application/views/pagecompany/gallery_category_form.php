<section role="main" class="content-body">
  ...
  <section class="panel">
    ...
    <?php 
      ...
      echo form_open_multipart("CompanyGalleryCategory/$method/$cat_id",$attributes); ?>
...
<script type="text/javascript">
  ...
  function editlanguage(id) {
      ...
      $.getJSON( "<?=base_url("CompanyGalleryCategory/getLanguageJson/")?>"+id, function( data ) {       
  ...
  function deletelanguage(id) {
    if(confirm('Delete this language?')){
      $.get('<?=base_url("CompanyGalleryCategory/deletelanguage/")?>' + id,function (data) {        
  ...
  function savelanguage() {
    ...
    $.post('<?=base_url("CompanyGalleryCategory/savelanguage")?>',frm,function(data) {
