...
<h2 style="padding-left: 15px;">Item Contactus</h2>
    <div class="form-group hide">
      <label class="col-md-2 control-label" for="">Header</label>
        <div class="col-md-10 col-sm-6 col-xs-12">
            <textarea class="form-control ckeditor" id="mapdesc" name="mapdesc" placeholder="mapdesc" ><?=isset($i->mapdesc)?$i->mapdesc:''?></textarea>
            
        </div>
    </div>
    <div class="form-group">
      <label class="col-md-2 control-label" for="">Contactus Demo</label>
        <div class="col-md-10 col-sm-6 col-xs-12">
            <img src="<?=base_url("assets/contact_information_template.jpg")?>" class="img-responsive" style="filter: grayscale(100%);">
        </div>
    </div>
