...
?>
 <div class="form-group">
    ...
    <div class="form-group">
      <label class="col-md-2 control-label" for="">Slide</label>
        <div class="col-md-2 col-sm-6 col-xs-12">
            <?php 
                $slide_id = isset($i->slide_id)?$i->slide_id:0;
                $data = array(
                    'class' =>'form-control' ,                  
                    'id'=>'slide_id',                                 
                );
                  
                echo form_dropdown('slide_id', $slide , $slide_id ,$data);
            ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10 col-sm-6 col-xs-12">            
            <h2>Get All Products from database</h2>
            <img src="<?=base_url("assets/slide_template.jpg")?>" class="img-responsive" style="">
        </div>
    </div>
