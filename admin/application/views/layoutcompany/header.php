<header class="header" style="background:#e8e8e8;border-top:0px;border-bottom:3px solid #FF5722;height:65px;" >
	<div class="logo-container">
		<a href="/admin/" class="logo" >
			<img src="<?php echo base_url('images/brandex_logo.png') ?>" width="200" height="50" alt="" />
		</a>
