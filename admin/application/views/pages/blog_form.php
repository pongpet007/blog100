<section role="main" class="content-body">
  ...
  <section class="panel">
    ...
    <?php 
      ...
      echo form_open_multipart("Blog/$method/$blog_id",$attributes); ?>
          ...
          <div class="form-group">
            <label class="col-md-2 control-label" for="">Meta Keyword</label>
              <div class="col-md-10">
              <?php 
              $meta_keyword = is_object($blog)?$blog->meta_keyword:'';
              $data = array(
                  'class' =>'form-control' ,
                  'rows'=>2,
                  'name' =>'meta_keyword',
          ...
          <div class="form-group">
            <label class="col-md-2 control-label" for="">Meta Description</label>
              <div class="col-md-10">
              <?php 
              $meta_description = is_object($blog)?$blog->meta_description:'';
              $data = array(
                  'class' =>'form-control' ,
                  'rows'=>2,
