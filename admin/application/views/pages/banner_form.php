<section role="main" class="content-body">
  ...
  <section class="panel">
    ...
    <?php 
      ...
      echo form_open_multipart("Banner/$method/$banner_id",$attributes); ?>
          
          <div class="form-group">
            <label class="col-md-2 control-label" for=""></label>
              <div class="col-md-10 ">
                <img src="<?php echo base_url('images/banner-home.jpg') ?>" class="img-responsive" alt="">
              </div>
          </div>
           ...
           <div class="form-group">
            <label class="col-md-2 control-label" for="">Position</label>
              ...
              <?php 
                ...
                $options = array(1=>' Banner 1',2=> ' Banner 2', 3=> ' Banner 3',4=> ' Banner 4',5=> ' Banner 5');
          ...
          <div class="form-group">
            <label class="col-md-2 control-label" for="">Expire</label>
              <div class="col-md-3">
              <?php 
              $expire = is_object($banner)?$banner->expire:'';
              $data = array(
