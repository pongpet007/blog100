...
class Company_category_model extends CI_Model{
	...
	public function getAll($com_id){
		...
		$this->db->select('company_category.*,cat_name');

		$this->db->from('company_category')	
		->join('company_category_language','company_category.cat_id=company_category_language.cat_id and company_category_language.country_id=236','left')			;
